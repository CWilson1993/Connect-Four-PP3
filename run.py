...
# Below is the empty initial stacks,
# the board will require 7 stacks(columns) to play connect four
def initialStacks():
    S = [Stack(), Stack(), Stack(),
...
# The below code makes a random choice for the computer
# and prompts the player to make a move, giving parameters for the choice
...
# it includes the initial prompt for the user to choice and identifier
